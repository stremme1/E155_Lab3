...
VL_ATTR_COLD void Vtb_debouncer_verilator___024unit___ctor_var_reset(Vtb_debouncer_verilator___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_debouncer_verilator___024unit___ctor_var_reset\n"); );
